...
! function(e, t, n) {
  ...
  t.infinitescroll = function(n, r, i) {
    ...
    _binding: function(t) {
      var r = this,
          i = r.options;
      if (i.v = "2.0b2.120520", i.behavior && this["_binding_" + i.behavior] !== n) this["_binding_" + i.behavior].call(this);
      else {
        if ("bind" !== t && "unbind" !== t) return this._debug("Binding value  " + t + " not valid"), !1;
        "unbind" === t ? this.options.binder.unbind("smartscroll.infscr." + r.options.infid) : this.options.binder[t]("smartscroll.infscr." + r.options.infid, (function() {
          r.scroll()
    ...
    _create: function(i, s) {
      ...
      if (!f) return this._debug("Navigation selector not found"), !1;
      o.path = o.path || this._determinepath(f), o.contentSelector = o.contentSelector || this.element, o.loading.selector = o.loading.selector || o.contentSelector, o.loading.msg = o.loading.msg || t('<div id="infscr-loading"><img alt="Loading..." src="' + o.loading.img + '" /><div>' + o.loading.msgText + "</div></div>"), (new Image).src = o.loading.img, o.pixelsFromNavToBottom === n && (o.pixelsFromNavToBottom = t(document).height() - t(o.navSelector).offset().top, this._debug("pixelsFromNavToBottom: " + o.pixelsFromNavToBottom));
      var l = this;
      return o.loading.start = o.loading.start || function() {
        ...
        o.behavior && e["_callback_" + o.behavior] !== n && e["_callback_" + o.behavior].call(t(o.contentSelector)[0], r, i), s && s.call(t(o.contentSelector)[0], r, o, i), o.prefill && u.bind("resize.infinite-scroll", e._prefill)
    ...
    _prefill: function() {
      ...
      this._prefill = function() {
        s() && r.scroll(), i.bind("resize.infinite-scroll", (function() {
          s() && (i.unbind("resize.infinite-scroll"), r.scroll())
        }))
      }, this._prefill()
    },
    _debug: function() {
    ...
    _determinepath: function(t) {
      ...
      if (r.behavior && this["_determinepath_" + r.behavior] !== n) return this["_determinepath_" + r.behavior].call(this, t);
      if (r.pathParse) return this._debug("pathParse manual"), r.pathParse(t, this.options.state.currPage + 1);
      
      if (t.match(/^(.*?)\b2\b(.*?$)/)) {
        // t = t.match(/^(.*-?)\b2\b(.*?$)/).slice(1);
        var str = t;
        t = [str.substring(0, str.lastIndexOf("/") + 1), ''];
      }
      else if (t.match(/^(.*?)2(.*?$)/)) {
    ...
    _error: function(t) {
      var r = this.options;
      r.behavior && this["_error_" + r.behavior] !== n ? this["_error_" + r.behavior].call(this, t) : ("destroy" !== t && "end" !== t && (t = "unknown"), this._debug("Error", t), ("end" === t || r.state.isBeyondMaxPage) && this._showdonemsg(), r.state.isDone = !0, r.state.currPage = 1, r.state.isPaused = !1, r.state.isBeyondMaxPage = !1, this._binding("unbind"))
    },
    _loadcallback: function(i, s, o) {
      var l, u = this.options,
          a = this.options.callback,
          f = u.state.isDone ? "done" : u.appendCallback ? "append" : "no-append";
      if (u.behavior && this["_loadcallback_" + u.behavior] !== n) this["_loadcallback_" + u.behavior].call(this, i, s);
      else {
        switch (f) {
          case "done":
            return this._showdonemsg(), !1;
          case "no-append":
            "html" === u.dataType && (s = t(s = "<div>" + s + "</div>").find(u.itemSelector));
            break;
          case "append":
            var c = i.children();
            if (0 === c.length) return this._error("end");
            for (l = document.createDocumentFragment(); i[0].firstChild;) l.appendChild(i[0].firstChild);
            this._debug("contentSelector", t(u.contentSelector)[0]), t(u.contentSelector)[0].appendChild(l), s = c.get()
        }
        if (u.loading.finished.call(t(u.contentSelector)[0], u), u.animate) {
        ...
        u.animate || (u.state.isDuringAjax = !1), a(this, s, o), u.prefill && this._prefill()
      }
    },
    _nearbottom: function() {
      var i = this.options,
          s = 0 + t(document).height() - i.binder.scrollTop() - t(e).height();
      return i.behavior && this["_nearbottom_" + i.behavior] !== n ? this["_nearbottom_" + i.behavior].call(this) : (this._debug("math:", s, i.pixelsFromNavToBottom), s - i.bufferPx < i.pixelsFromNavToBottom)
    },
    _pausing: function(t) {
      var r = this.options;
    ...
    _showdonemsg: function() {
      var r = this.options;
      r.behavior && this["_showdonemsg_" + r.behavior] !== n ? this["_showdonemsg_" + r.behavior].call(this) : (r.loading.msg.find("img").hide().parent().find("div").html(r.loading.finishedMsg).animate({
        opacity: 1
      }, 2e3, (function() {
    ...
    _validate: function(n) {
      for (var r in n)
        if (r.indexOf && r.indexOf("Selector") > -1 && 0 === t(n[r]).length) return this._debug("Your " + r + " found no elements."), !1;
      return !0
    },
    bind: function() {
      this._binding("bind")
    ...
    beginAjax: function(r) {
      var o, u, a, f, i = this,
          s = r.path;
      if (r.state.currPage++, r.maxPage != n && r.state.currPage > r.maxPage) return r.state.isBeyondMaxPage = !0, void this.destroy();
      switch (o = t(r.contentSelector).is("table, tbody") ? t("<tbody/>") : t("<div/>"), u = "function" == typeof s ? s(r.state.currPage) : s.join(r.state.currPage), i._debug("heading into ajax", u), a = "html" === r.dataType || "json" === r.dataType ? r.dataType : "html+callback", r.appendCallback && "html" === r.dataType && (a += "+callback"), a) {
        case "html+callback":
          i._debug("Using HTML via .load() method"), o.load(u + " " + r.itemSelector, n, (function(t) {
            i._loadcallback(o, t, u)
          }));
          break;
        case "html":
          i._debug("Using " + a.toUpperCase() + " via $.ajax() method"), t.ajax({
            url: u,
            dataType: r.dataType,
            complete: function(t, n) {
              (f = void 0 !== t.isResolved ? t.isResolved() : "success" === n || "notmodified" === n) ? i._loadcallback(o, t.responseText, u): i._error("end")
            }
          });
          break;
        case "json":
          i._debug("Using " + a.toUpperCase() + " via $.ajax() method"), t.ajax({
            ...
            success: function(e, t, s) {
              if (f = void 0 !== s.isResolved ? s.isResolved() : "success" === t || "notmodified" === t, r.appendCallback)
                if (r.template !== n) {
                  var a = r.template(e);
                  o.append(a), f ? i._loadcallback(o, a) : i._error("end")
    ...
    retrieve: function(r) {
      r = r || null;
      var s = this.options;
      if (s.behavior && this["retrieve_" + s.behavior] !== n) this["retrieve_" + s.behavior].call(this, r);
      else {
    ...
    scroll: function() {
      var t = this.options,
          r = t.state;
      t.behavior && this["scroll_" + t.behavior] !== n ? this["scroll_" + t.behavior].call(this) : r.isDuringAjax || r.isInvalidPage || r.isDone || r.isDestroyed || r.isPaused || this._nearbottom() && this.retrieve()
    },
    toggle: function() {
      this._pausing()
    },
    ...
    switch (i) {
      case "string":
        ...
        this.each((function() {
          ...
          return !!e && (!(!t.isFunction(e[n]) || "_" === n.charAt(0)) && void e[n].apply(e, s))
        }));
        break;
      case "object":
        this.each((function() {
          var e = t.data(this, "infinitescroll");
          e ? e.update(n) : (e = new t.infinitescroll(n, r, this)).failed || t.data(this, "infinitescroll", e)
        }))
    }
    return this
  };
 ...
 */
  ...
  function o(t) {
    ...
    return function() {
      if (p) {
        ...
        e.appendChild(t);
        var n = a(t);
        r = 200 === i(n.width), e.removeChild(t)
      }
    }(),
      function(t) {
      if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
        ...
        var y = s.paddingLeft + s.paddingRight,
            ...
            L = u && r,
            S = i(e.width);
        !1 !== S && (s.width = S + (L ? 0 : y + b));
        var T = i(e.height);
        return !1 !== T && (s.height = T + (L ? 0 : g + E)), s.innerWidth = s.width - (y + b), s.innerHeight = s.height - (g + E), s.outerWidth = s.width + v, s.outerHeight = s.height + _, s
      }
    }
  }
  ...
  n.getListeners = function(t) {
    ...
    for (o in r) r.hasOwnProperty(o) && (-1 !== (n = e(r[o], i)) && r[o].splice(n, 1));
    return this
  ...
  if (a) {
    var p = i(document.createElement("div"), "div");
    s = p ? i : function(t, e) {
      return n(t), i(t, e)
    }
  } else s = function(t, e) {
  ...
  function o(t, o, r) {
    ...
    })(a.prototype, t.prototype), a.prototype._create = function() {
      this._transition = {
        ingProperties: {},
        clean: {},
        onEnd: {}
  ...
  function s(i, s, f, l, d, m) {
    function y(t, i) {
      ...
      } else h && h.error("Bad " + this.settings.namespace + " element: " + t)
    }
    function g(t, i) {
    ...
    return y.prototype.settings = {
      ...
      } else this.emitEvent("layoutComplete", [this, t])
      ...
      return e(n.prototype, y.prototype), g(n, "options"), g(n, "settings"), e(n.prototype.options, i), n.prototype.settings.namespace = t, n.data = y.data, n.Item = function() {
        ...
        }(t), i = a.querySelectorAll(".js-" + e), o = "data-" + e + "-options", s = 0, u = i.length; u > s; s++) {
          var f, c = i[s],
              l = c.getAttribute(o);
          try {
            f = l && JSON.parse(l)
  ...
  function r(e, n) {
    ...
    r.prototype = new e, r.prototype.options = {}, r.prototype.getImages = function() {
      ...
      function e(e, r) {
        return t.options.debug && a && s.log("confirm", e, r), t.progress(e), ++n === i && t.complete(), !0
      }
      var t = this,
          n = 0,
    ...
    return c.prototype = new e, c.prototype.check = function() {
      ...
      else if (f[this.img.src] = this, this.img.complete && void 0 !== this.img.naturalWidth) this.confirm(0 !== this.img.naturalWidth, "naturalWidth");
      else {
